...
# Get all artifacts.
FILELIST=`lxc exec ${CONTAINER} -- bash -c 'find "/tmp/work" -path "/tmp/work/build/com.github.brimworks-lua5.1-lua-zlib/targets/jonchki/repository/com/github/brimworks/lua-zlib/*" -type f'`
echo ${FILELIST}
